\section{Mediciones de rendimiento (Sin fallas)}
...
Una consideración importante es que estas mediciones fueron realizadas previas a la implementación de los sistemas de tolerancia a fallas y recuperación ante
errores.
Por lo tanto, los resultados reflejan el rendimiento del sistema en una versión donde no se hacen operaciones de lectura y escritura constante. Lo que reduce de forma significativa el tiempo de procesamiento total.
