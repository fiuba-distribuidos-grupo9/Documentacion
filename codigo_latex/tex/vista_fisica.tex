...
\subsection{Diagrama de Robustez - Primera Consulta (Primera mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Primera Consulta (Primera mitad)}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Primera Consulta (Segunda mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Primera Consulta (Segunda mitad)}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Segunda Consulta (Primera mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Segunda Consulta (Primera mitad)}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Segunda Consulta (Segunda mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Segunda Consulta (Segunda mitad)}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Tercera Consulta (Primera mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Tercera Consulta (Primera mitad)}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Tercera Consulta (Segunda mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Tercera Consulta (Segunda mitad)}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Cuarta Consulta (Primera mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Cuarta Consulta (Primera mitad)}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Cuarta Consulta (Segunda mitad)}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Cuarta Consulta (Segunda mitad)}
  \label{fig:robustez}
\end{figure}
...
Dentro de las operaciones del sistema distribuido, existen cinco que admiten escalabilidad 
...
\begin{itemize}
    ...
    \item \textbf{Join}
    \item \textbf{Map}
    \item \textbf{Output Builder}
\end{itemize}

Como decisión de diseño, se definió que en los casos donde el sistema cuente con una 
disposición de $N$ nodos de alguno de los cinco tipos mencionados, comunicándose con 
...
Tampoco se escalaran con múltiples computadoras las operaciones 'Reduce' y 'Sort'. Ya que son 'Stateful' y su correcto funcionamiento e implementación se ve muy beneficiado de ejecutarse en una sola instancia de computación, sin perder un rendimiento perceptible.

\newpage

\textbf{Caso particular}: Para el escenario de los \textit{Join} con la tabla de \textit{Usuarios}, 
se habilita la escalabilidad a múltiples nodos con particiones arbitrarias sobre el total de los usuarios, dado que el volumen de datos 
puede ser significativamente grande como para entrar en un único nodo.  
