...
\subsection{Diagrama de Robustez - Completo}
...
\subsection{Diagrama de Robustez - Fragmento superior}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Fragmento superior}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Fragmento medio}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Fragmento medio}
  \label{fig:robustez}
\end{figure}

\newpage

\subsection{Diagrama de Robustez - Fragmento inferior}
...
\begin{figure}[H]
  ...
  \caption{Diagrama de Robustez - Fragmento inferior}
  \label{fig:robustez}
\end{figure}

\newpage

\subsubsection{Escalabilidad de las Operaciones}
...
\textit{Join} que se realizan con las tablas de \textit{Menú} y de \textit{Tiendas}, 
...
Tampoco se escalaran con múltiples computadoras las operaciones 'Map', 'Count', 'Sort' y 'Output Builder'. Ya que son 'Stateful' y su correcto funcionamiento e implementación se ve muy beneficiado de ejecutarse en una sola instancia de computación, sin perder un rendimiento perceptible.
