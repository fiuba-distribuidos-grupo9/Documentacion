...
\begin{itemize}
    \item Frecuencia de generación de fallas: \texttt{120 segundos}.
    \item Duración total de la prueba: \texttt{11 minutos}.
    \item Cantidad de nodos involucrados: \texttt{63}.
...
\begin{itemize}
    ...
    \item Cantidad total de nodos en ejecución: \texttt{63}.
    \item Cantidad de consultas simultáneas: \texttt{5 (1 Cliente)}.
    \item Duración de la medición: Aproximadamente se estiman \texttt{50 minutos}, no se realizó la medición en su totalidad para evitar daños en el disco de la computadora.
\end{itemize}
