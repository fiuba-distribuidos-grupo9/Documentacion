...
\begin{itemize}
    ...
    \item Rediseño del protocolo de comunicación.
    \item Implementación de los mecanismos de tolerancia a fallas en los controladores.
    \item Integración de los 'Health Checkers' con el Sistema Distribuido.
    \item Implementación de la nueva lógica de envío de mensajes a próximos controladores.
    \item Agregado de la generación de UUID de los mensajes en el Servidor.
    \item Verficación de control ante posible duplicación de mensajes.
\end{itemize}
...
\begin{itemize}
    \item Planificación y diseño de la arquitectura tolerante a fallas.
    \item Implementación de los mecanismos de tolerancia a fallas en los controladores:
    \item Testing extensivo del sistema ante fallas.
    \item Medición del rendimiento del sistema con tolerancia a fallas.
    \item Investigación de atomocidad en operaciones de archivos.
    \item Implementación de la reconstrucción de estados de los controladores Statefull ante caídas.
    \item Adaptación de los controladores a los cambios de protocolo.
\end{itemize}

\subsection*{Felipe}
\begin{itemize}
    \item Planificación y diseño de la arquitectura tolerante a fallas.
    \item Redacción de la documentación final del sistema (Añadidos de tolerancia a fallas).
    \item Redacción de la presentación para la defensa final.
    \item Implementación de la herramienta 'Chaos-Monkey' para la generación de fallas controladas.
    \item Implementación del algoritmo de elección de lider para los 'Health Checkers'.
    \item Implementación inicial del funcionamiento de los 'Health Checkers'.
    \item Relevamiento de todos los criterios de corrección y aceptación del sistema.
\end{itemize}
