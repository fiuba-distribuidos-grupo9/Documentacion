...
\begin{enumerate}
    \item \textbf{Cleaner}: Se encarga de la limpieza de los datos de entrada, eliminando campos que resultan innecesarios
    para las consultas. Es escalable.
    ...
    definido en la consulta (por ejemplo, filtrar por fechas, montos o rangos horarios). Es escalable.
    ...
    de una fecha, o calcular un contador auxiliar. Es escalable.
    ...
    de qué métrica se busque consolidar. No es escalable.
    ...
    la fecha de nacimiento del cliente). Es escalable.
    ...
    significativos en cada consulta (por ejemplo, productos más vendidos). No es escalable.

    \item \textbf{OutputBuilder}: Es el último paso en la cadena de operaciones, se encarga de formatear la respuesta que va a ser
    enviada al usuario. Es escalable.
\end{enumerate}
...
configuración necesaria para que realice la tarea solicitada de la mejor forma posible.
