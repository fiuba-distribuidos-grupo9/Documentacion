...
secuencial. Para cada usuario que se conecte, se respetera una secuencia específica de ejecución.
...
\begin{itemize}
    ...
    solicitadas mediante unos archivos generados en la carpeta \texttt{'.results/query\_results'} en formato '.txt'. Se genera un archivo por cada consulta.
\end{itemize}
